...
const AboutGalleryButton = ({
    ...
    return (
        ...
        //     className='text-black cursor-pointer pb-[5px] pl-[3px] duration-200 hover:pb-0 hover:pl-0 hover:pt-[5px] hover:pr-[3px] group'
        //     onClick={handleClick}
        // >
        ...
        //             {children}
        //         </div>
        //         <div className='w-full h-full absolute z-0 rounded-full border border-white top-[5px] -left-[3px] group-hover:top-0 group-hover:left-0 duration-200 '></div>
        //     </div>
        // </button>
        ...
        <button
            type='button'
            aria-label='Předchozí obrázek'
            className={`text-black cursor-pointer pb-[5px] pl-[3px] duration-200 hover:pb-[2px] hover:pl-[2px] hover:pt-[3px] hover:pr-[1px] group ${
