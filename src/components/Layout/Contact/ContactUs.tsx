...
const ContactUs = () => {
    return (
        <section className='pt-16 w-full' id='contact-form'>
            <div className='relative h-full w-full text-white bg-radial-[at_80%80%] from-zinc-950 to-zinc-900 to-75% rounded-3xl p-10'>
                <div
                ...
                <div className='relative h-full pb-12 flex flex-col w-full gap-8 '>
