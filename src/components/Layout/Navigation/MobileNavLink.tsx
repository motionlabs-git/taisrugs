    ...
    return (
        ...
        >
            <div className='w-fit py-2 rounded-full pt-[]'>
                <span
                    className={`w-full h-full px-8 py-2 text-xl font-bold text-nowrap rounded-full border   ${
                        link === path
                            ? ' text-primary border-primary shadow-[-3px_3px_#ffdb85]'
                            : 'bg-black text-white border-white shadow-[-3px_3px_white]'
                    } group-hover:shadow-[0_0] duration-200 ${
